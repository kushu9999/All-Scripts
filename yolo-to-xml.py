...
CLASS_MAPPING = {
       ...
       '1': '100-indian-rupees',
       '2': '20-indian-rupees',
       '3': '20-New-indian-rupees',
       '4': '10-New-indian-rupees',
       '5': '10-indian-rupees',
       '6': '50-indian-rupees',
       '7': '50-New-indian-rupees',
       '8': '2000-indian-rupees',
       '9': '200-indian-rupees'
...
def read_file(file_path):
    ...
    with open(os.path.join(ANNOTATIONS_DIR_PREFIX,file_path), 'r') as file:
        ...
        for line in lines:
            ...
            a = int(data[0])
            if  a == 0:
                voc.append("500-indian-rupees")
            if  a == 1:
                voc.append("100-indian-rupees")
            if  a == 2:
                voc.append("20-indian-rupees")
            if  a == 3:
                voc.append("20-New-indian-rupees")
            if  a == 4:
                voc.append("10-New-indian-rupees")
            if  a == 5:
                voc.append("10-indian-rupees")
            if  a == 6:
                voc.append("50-indian-rupees")
            if  a == 7:
                voc.append("50-New-indian-rupees")
            if  a == 8:
                voc.append("2000-indian-rupees")
            if  a == 9:
                voc.append("200-indian-rupees")
